      ...
      <div className="relative inline-block">
        ...
        <a
          ...
          <div className="mx-12 my-6 text-gray-400 text-sm">
            ...
            <h1 className="text-green-800 font-bold my-2">{enabled ? 'Aktif' : 'Non-Aktif'}</h1>
            <div>
      <Switch
        checked={enabled}
        onChange={setEnabled}
      ...
      >
        ...
        />
          ...
          <div className="mx-12 my-6 text-gray-400 text-sm">
            ...
            <div className="flex items-center place-content-between">
            <h1 className="text-gray-800 my-2">Jl. Tebet Raya No.42, Jakarta Selatan</h1>
            </div>
          </div>
          <div className="mx-12 my-6 text-gray-400 text-sm">
          ...
          <div className="mx-12 my-6 text-gray-400 text-sm">
            ...
            <h1 className="text-green-800 my-2 underline underline-offset-1">mig@mitrasolusi.group</h1>
            </div>
          </div>
          <div className="mx-12 my-6 text-gray-400 text-sm">
            <h1>No. Telp</h1>
          ...
          <div className="mx-12 my-6 text-gray-400 text-sm">
            ...
            <h1 className="text-green-800 my-2 underline underline-offset-1">mitramas.com</h1>
            </div>
          </div>
      </div>
    </div>
